  ...
  return (
    ...
    >
      <h1 className='text-xl font-semibold'>
        <span className='capitalize'>create </span>a new student
      </h1>
      ...
      <span className='text-xs text-gray-400 font-medium capitalize'>personal information</span>
      ...
      <div className='flex justify-between flex-wrap gap-4'>
        ...
        <div className='flex flex-col gap-2 w-full md:w-1/4'>
          <label className='text-xs text-gray-500 capitalize'>sex</label>
        ...
        <div className='flex flex-col gap-2 w-full md:w-1/4 justify-center'>
          ...
          >
            ...
            <span className='capitalize'>upload </span>a photo
          </label>
      ...
      <button className='bg-blue-400 text-white p-2 rounded-md capitalize'>{type === 'create' ? 'create' : 'update'}</button>
    </form>
  );
};
